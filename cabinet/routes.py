...
def setup_cabinet_routes(app: web.Application):
    ...
    app.router.add_put('/cabinet/api/pipeline/quotes/{id}', api.pipeline_quotes_update)
    ...
    app.router.add_post('/cabinet/api/pipeline/cards/{id}/buyer-search', api.pipeline_buyer_search)
    ...
    app.router.add_get('/cabinet/api/suppliers/{id}/products', api.suppliers_list_products)
    app.router.add_post('/cabinet/api/suppliers/{id}/products', api.suppliers_add_product)
    app.router.add_put('/cabinet/api/supplier-products/{id}', api.supplier_products_update)
    app.router.add_delete('/cabinet/api/supplier-products/{id}', api.supplier_products_delete)
