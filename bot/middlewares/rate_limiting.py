...
class AdaptiveRateLimitMiddleware(RateLimitMiddleware):
    ...
    COMMAND_LIMITS = {
        ...
        "search": 3,           # 3 поиска в минуту
        "analyze": 2,          # 2 анализа в минуту
        "sniper_search": 3,    # 3 снайпер поиска в минуту

        # Обычные операции
        "filter_create": 5,    # 5 создания фильтров в минуту
        "filter_list": 10,     # 10 просмотров списка в минуту

        # Легкие операции
        "menu": 20,            # 20 переходов по меню в минуту
        "help": 15,            # 15 запросов помощи в минуту
        "default": 10          # Базовый лимит
    }
