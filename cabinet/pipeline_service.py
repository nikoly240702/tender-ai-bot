...
STAGE_RESULT = 'RESULT'
STAGE_REJECTED = 'REJECTED'  # Решили не участвовать после изучения

ALL_STAGES = [STAGE_FOUND, STAGE_IN_WORK, STAGE_RFQ, STAGE_QUOTED, STAGE_SUBMITTED, STAGE_RESULT, STAGE_REJECTED]
