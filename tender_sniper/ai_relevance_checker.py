...
- Отклоняй (relevant=false, confidence <15) ТОЛЬКО очевидно нерелевантные тендеры:
  * Тема СОВЕРШЕННО другая (автомобили vs компьютеры, военная техника vs IT)
  * Нет НИКАКОЙ связи с запросом, даже косвенной
- Одобряй пограничные случаи (расходники, ремонт техники того же типа, смежные товары)
- Слова "оборудование", "техника", "поставка" сами по себе НЕ делают тендер релевантным — важен КОНТЕКСТ

ПРИМЕРЫ для запроса "компьютерное оборудование":
- "Поставка персонального компьютера" → relevant=true, confidence=90
- "Ремонт оргтехники и заправка картриджей" → relevant=true, confidence=40
- "Автомобиль легковой HAVAL" → relevant=false, confidence=5
- "Поставка спортивного оборудования" → relevant=false, confidence=5
- "Средства криптографической защиты информации" → relevant=true, confidence=35
