...
{
    "requirements": {
        "licenses": ["список требуемых лицензий"],
    ...
    "deadlines": {
        ...
        "execution_description": "описание сроков",
    ...
    "technical_specs": {
        "main_items": ["основные позиции/товары/работы"],
        "quantities": "количество если указано",
    ...
    "summary": "краткое резюме ключевых условий (2-3 предложения)"
}

ВАЖНО:
- Извлекай только то, что ЯВНО указано в документации
- Если информация не найдена - ставь null
- Числа указывай без единиц измерения (просто число)
- Проценты указывай как число (10, а не "10%")
