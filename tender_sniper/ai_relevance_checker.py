...
ВАЖНО:
- Слово "разработка" в тендере НЕ означает IT, если контекст другой (охранные зоны, месторождения, проектная документация)
- Слово "система" НЕ означает IT (пожарная система, система отопления, система охраны)
- Слово "транспортировка" может быть нерелевантна логистике (транспортировка отходов, биоматериалов)
